...
module.exports = {
  ...
  langs: {
    ar: {
      ...
      session4: "مساء",
      welcomeMessage:
        "🤖 تم توصيل الروبوت بنجاح\n 🙆 المطور: https://www.facebook.com/ricodzz📝 بوت قيد التطوير لذا اي مشكل قل للمطور يصلحه\n🌸🌝 يوما سعيدا لكم",
      multiple1: " ",
      multiple2: "م",
      ...
      if (
        ...
        return message.send({
          ...
          attachment: await getStreamFromURL(
            "https://i.ibb.co/sb7fBMY/368517504-168260926291434-2554379017632772114-n-jpg-stp-dst-jpg-p480x480-nc-cat-107-ccb-1-7-nc-sid-a.jpg",
          ),
        });
      }
      // if new member:
